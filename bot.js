...
Object.defineProperty(global, "LIKE_DELAY", { get: function(){ return ~~Math.rndRange(800,1500); } });
...
var userId           = getUserIdFromFile();                            //Get it here http://findmyfacebookid.com/
var cookie           = getFBCookieFromFile();                          //FB cookie: Open your favorite browser and JS debugger and do a window.document.cookie
...
function getUserIdFromFile(fileName){
...
function getFBCookieFromFile(fileName){
